...
"""
    ...
    for username, user_data in data["users"].items():
        if not user_data: continue # تخطي المستخدمين الذين لديهم بيانات فارغة (None)
        ...
        # تحقق من أن القيمة ليست None قبل أن تحاول اقتطاعها
...
"""
        ...
        for video_id, video_data in sorted_videos:
            if not video_data: continue # إضافة حماية إضافية هنا
